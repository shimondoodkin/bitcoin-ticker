...
parseconfirmationpacket=function(ret)
{
...
parsesubcommandpacket=function(ret)
{
 //Data-position  Data-Items  Length(byte)  Description
 var data=ret.packetData;
 var c=0;
...
parseversionpacket=function(ret)
{
 //Data-position  Data-Items  Length(byte)  Description
 var data=ret.packetData;
 var c=0;
...
packetsend=function(command,data)
{
 var body=
...
packetreturn=function(command,data)
{
 var body=
...
setControllerIdAndBaudRate=function(){
...
rich3=function(color,size,letters)
{
...
sendTextDataToASpecifiedWindow=function() // send temporary message i guess
{
 ...
 +rich3('r','3','Hello ')    // String	Variable-length	Every 3 bytes to represent a character. Refer to Rich3 text of Formatted text data format.
...
sendInstantStaticText=function()
{
 var data=                  // Send static text：CC=0x04:  
                            // Data-Items	Value	Length(byte)	Description
  '\u0004'                  //CC	0x04	1	Description of the data packet is static text
...
specialEffectForTextAndPictureOrderdNames=
["Draw" // 0
,"Open from left" // 1
,"Open from right" // 2
